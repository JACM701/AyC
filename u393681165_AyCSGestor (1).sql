...
-- Tiempo de generación: 07-08-2025 a las 20:07:22
...
(65, 7, 18, 'Caja Estanca de Registro para Cámara', 'Accesorios', '0', 3.00, 50.00, 150.00, NULL, 0.00),
...
(100, 7, 23, 1, 650.00, 650.00),
(101, 7, 12, 2, 690.00, 1380.00),
(102, 7, 72, 90, 2135.00, 192150.00),
(103, 7, 47, 3, 70.00, 210.00),
(104, 7, 114, 3, 10.00, 30.00),
(105, 7, 79, 1, 350.00, 350.00),
...
(14, 7, NULL, 'Servicio de Instalación y Configuración  de Cámaras', 'Servicio de Instalación y Configuración \nde Cámaras \nSKU: CYA-EXTERA1-UTP', 3.00, 450.00, 1350.00, 'uploads/services/servicio_1754002609_688bf4b1d977a.png', '2025-08-06 21:45:41'),
...
(57, 'Fuente de Alimentación de 4 Salidas de 11 - 15 Vcc / 5 Amper / Voltaje de Entrada 110- 240 Vac / Fus', 'PS-12-DC-4C', '697477291003', 254.88, 196.06, 1, NULL, NULL, 4, 33, 'Fuente de Alimentación de 4 Salidas de 11 - 15 Vcc / 5 Amper / Voltaje de Entrada 110- 240 Vac / Fusible Termico PTC Integrado para Protección / Salida de Voltaje Inteligente hasta 3 Amper por Salida', 'uploads/products/prod_68753c0fad4ae.png', 'normal', '0', NULL, '2025-07-14 17:19:11', '2025-08-07 14:56:38'),
...
--
ALTER TABLE `cotizaciones`
  MODIFY `cotizacion_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `cotizaciones_historial`
  MODIFY `historial_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT de la tabla `cotizaciones_insumos`
--
ALTER TABLE `cotizaciones_insumos`
  MODIFY `cotizacion_insumo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;

--
-- AUTO_INCREMENT de la tabla `cotizaciones_productos`
--
ALTER TABLE `cotizaciones_productos`
  MODIFY `cotizacion_producto_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;

--
-- AUTO_INCREMENT de la tabla `cotizaciones_servicios`
--
ALTER TABLE `cotizaciones_servicios`
  MODIFY `cotizacion_servicio_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
