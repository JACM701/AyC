...
// Para los selects de acciones y usuarios (hacer ANTES de recorrer $historial)
...
<head>
    <meta charset="UTF-8">
    <title>Historial Global de Cotizaciones | Gestor de inventarios</title>
...
<body>
    ...
    <main class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="bi bi-clock-history"></i> Historial Global de Cotizaciones</h2>
            ...
            <form method="GET" class="row g-3 align-items-end" autocomplete="off">
                ...
                <div class="col-md-3 col-12">
                    <div class="d-flex gap-2 align-items-end">
                        ...
                        <a href="historial_global.php" class="btn btn-outline-secondary w-100"><i class="bi bi-arrow-clockwise"></i> Limpiar</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <script>document.querySelector('.sidebar-cotizaciones').classList.add('active');</script>
</body>
</html> 