            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
                                <label for="email" class="form-label">Usuario o correo de TVC.mx:</label>
                                <input type="text" class="form-control" name="email" id="email" placeholder="Usuario o correo de TVC.mx"
                                       value="<?= htmlspecialchars($current_config['tvc_username'] ?? '') ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="password" class="form-label">Contraseña de TVC.mx:</label>
                                <input type="password" class="form-control" name="password" id="password" 
                                       value="<?= htmlspecialchars($current_config['tvc_password'] ?? '') ?>" required>
                            </div>
